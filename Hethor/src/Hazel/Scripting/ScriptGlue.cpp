...
#include "Hethor/Core/Input.h"

#include "Hethor/Scene/Scene.h"
#include "Hethor/Scene/Entity.h"

#include "Hethor/Physics/Physics2D.h"
...
#define HZ_ADD_INTERNAL_CALL(Name) mono_add_internal_call("Hethor.InternalCalls::" #Name, Name)
	...
	static void RegisterComponent()
	{
		([]()
		{
			...
			std::string managedTypename = fmt::format("Hethor.{}", structName);
