...
#define HZ_PROFILE 0
	...
	#define HZ_PROFILE_BEGIN_SESSION(name, filepath) ::Hethor::Instrumentor::Get().BeginSession(name, filepath)
	#define HZ_PROFILE_END_SESSION() ::Hethor::Instrumentor::Get().EndSession()
	#define HZ_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Hethor::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::Hethor::InstrumentationTimer timer##line(fixedName##line.Data)
